...
class StoreCardRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'last_digits' => 'required|string|size:4|regex:/^\d{4}$/',
    ...
    public function messages(): array
    {
        return [
            ...
            'bank.required' => 'O banco emissor do cartão é obrigatório.',
            'last_digits.required' => 'Os últimos 4 dígitos do cartão são obrigatórios.',
