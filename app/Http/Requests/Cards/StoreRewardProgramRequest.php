...
class StoreRewardProgramRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => 'required|string|max:255|unique:reward_programs,name',
            'code' => 'sometimes|nullable|string|max:50|unique:reward_programs,code',
    ...
    {
        return [
            'name.required' => 'O nome do programa de recompensas é obrigatório.',
